...
#---- python run.py -i mylib/videos/test.mp4 ------------------------Parse req. arguments------------------------------#
...
labelsPath = os.path.sep.join([".\\core\\bd\\yolo\\coco.names"])
LABELS = open(labelsPath).read().strip().split("\n")


weightsPath = os.path.sep.join([".\\core\\bd\\yolo\\yolov3.weights"])
configPath = os.path.sep.join([ ".\\core\\bd\\yolo\\yolov3.cfg"])
